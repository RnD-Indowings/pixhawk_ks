...
# Connection string
connection_string = "127.0.0.1:14550"  # Use "COMx" or "/dev/ttyUSBx" for Pixhawk
...
def change_speed(connection, speed):
    connection.mav.command_long_send(
        ...
        0, speed, -1, 0, 0, 0, 0  # Airspeed type (0=ground speed), -1 to not change throttle
    )
...
def main():
    ...
    takeoff_to_altitude(connection, 20)  # Takeoff to 40m
